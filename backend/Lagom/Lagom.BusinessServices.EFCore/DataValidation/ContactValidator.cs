...
namespace Lagom.BusinessServices.EFCore.DataValidation
{
    internal class ContactValidator : LagomDBDataValidator<Contact>
    {
        internal override async Task<LagomDBDataValidatorResult> Validate(Contact entity, LagomDbContext dbContext)
        {
